...
/**
 * Integration contract for the follow-up host wiring: this does not reschedule itself,
 * so the host's onFire handler must call armSyncPull again to keep polling.
 */
