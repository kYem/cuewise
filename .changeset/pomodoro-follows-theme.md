...
Two things in the music player start working along the way: the pulsing dot that marks something as playing, and the tint behind the ambient sound icon. Both were written against a colour Cuewise doesn't define, so they had quietly never rendered at all.
